 ...
 */
@Component
public class CalculatePriceRequestMessage {
    //Initialization of the Logger
    private final static Logger LOG = LoggerFactory.getLogger(CalculatePriceRequestMessage.class);
    /*
     ...
     */
    @JobWorker(type = "calculate-price-request")
    public void calculatePriceRequest(final ActivatedJob job, final JobClient client) {
        ...
        //Making a list of process variable. This will be sent to the process instance
        ...
        camundaClient.newPublishMessageCommand()
                .messageName("calculatePriceRequest")
                .correlationKey("calculatePriceRequest")
                .variables(result)
                .send()
                .join();
