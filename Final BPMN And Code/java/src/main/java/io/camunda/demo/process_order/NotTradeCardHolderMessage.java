 ...
 */
@Component
public class NotTradeCardHolderMessage {
    //Initialization of the Logger
    private final static Logger LOG = LoggerFactory.getLogger(NotTradeCardHolderMessage.class);
    /*
    ...
    public void notTradeCardHolder(final ActivatedJob job, final JobClient client) {
        //Printing Log
        ...
        camundaClient.newPublishMessageCommand()
                .messageName("notTradeCardHolder")
                .correlationKey("notTradeCardHolder")
